...
OUTPUT_PATH_FILL = 'F:/Scan-flood-Fill/data/toy_examples/output_Scan_flood_Fill_crop_first_toy/'
colorThreshold = 35
...
def scan_flood_Fill_main():
    ...
    for i, n in enumerate(range(200, 2200, 200)):
        ...
        print("Scan-flood fill time(crop first) used for height=width= {} is:".format(str(n)))
        print(elapsed)
        fill_time[i] = elapsed
    print(fill_time)
    np.savetxt("scan_flood_Fill_time_size_crop_first.csv", fill_time, delimiter=",")
