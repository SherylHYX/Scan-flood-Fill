...
OUTPUT_PATH_FILL = 'F:/fill_boundary/output_holes0320/'
colorThreshold = 35
...
def holeFill_main():
    ...
    for i, n in enumerate(range(200, 400, 200)):
        ...
        print("Hole fill time used for size {} is:".format(str(n)))
        print(elapsed)
        fill_time[i] = elapsed
    print(fill_time)
    #np.savetxt("hole_fill_time_size.csv", fill_time, delimiter=",")
